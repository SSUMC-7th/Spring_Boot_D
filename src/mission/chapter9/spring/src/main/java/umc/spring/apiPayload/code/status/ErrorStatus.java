...
public enum ErrorStatus implements BaseErrorCode {
    ...
    INVALID_PAGE_NUMBER(HttpStatus.BAD_REQUEST, "PAGE4700", "올바른 페이지 번호가 아닙니다. 1 이상을 입력해 주세요."),

    MISSION_ASSIGNED_NOT_FOUND(HttpStatus.BAD_REQUEST, "MISSION4800", "진행 중인 미션이 없습니다."),

    MISSION_ASSIGNED_ALREADY_COMPLETED(HttpStatus.BAD_REQUEST, "MISSION4801", "이미 완료된 미션입니다.");
