...
public class MissionController {
    ...
    public ApiResponse<Void> completeMission(@RequestBody @Valid MissionAssignedRequestDTO.JoinDto request, @PathVariable @ExistMission Long missionId) {
        missionAssignedCommandService.completeMission(request, request.getUserId(), missionId);
