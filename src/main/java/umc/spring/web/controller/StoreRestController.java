...
public class StoreRestController {
    ...
    public ApiResponse<StoreResponseDTO.StoreMissionPreViewListDTO> getMissionList(@ExistStore @PathVariable(name = "storeId") Long storeId,@RequestParam(name = "page") Integer page){
